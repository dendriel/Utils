...
#                                                               #
# Description:                                                  #
#  This class allows you to comunicate with gsm modules by AMI  #
# (Asterisk Manager Interface). Initially created composing an  #
# abstraction to use the sms service by the base methods of the #
# base class.                                                   #
#################################################################
import socket
