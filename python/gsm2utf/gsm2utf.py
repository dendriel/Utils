...
#                                                               #
# Description:                                                  #
#  This script will translate a given sequence codified in gsm7 #
# to a legible codification (utf-8).                            #
#################################################################
import sys

# first message #
# 07 91 55 12 18 31 76 00 
# 04 0B 81 40 88 18 85 73 
# F6 00 00 21 30 50 11 33 
# 70 29 0A 
# 7669746F72726F7A7361
# 76 69 74 6F 72 72 6F 7A 73 61
#  v  i  t  o  r  r  o  z  s  a

# second message #
# 07 91 55 12 18 31 76 00
# 04 0B 81 40 88 18 85 73 
# F6 00 00 21 30 60 90 50
# 40 29 20
# 41 7A 5A 5E 4E AE 40 4F 10 3C 4C B7 81 04 20 F7 1B 74 0E BB E7 6F C1 0A 10 12 99 5A
#  A  z  Z  ^ 
#  A  t  i  r  e  I  +     O     p  a  t  6  $  n  o  g  a  n  s  o  $  +  @  !  "  &  -

# +CMGL: 9,"REC UNREAD","04888158376",,"12/03/06,09:19:28-12"                                                                                                   
# AtireI+ O pat6  no ganso+!"&-
...
if len(sys.argv) < 2:
	print "specify the string to be decoded"
	sys.exit(0)
